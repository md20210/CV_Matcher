...
const CVMatcherPage: React.FC = () => {
  ...
  const handleSaveToProject = async (document: Document) => {
    if (!selectedProject) {
    ...
    try {
      ...
      const newDocument = await documentsService.createTextDocument(
        selectedProject.id,
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        {loading && (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-600">Analysiere Übereinstimmung...</p>
          </div>
        )}
